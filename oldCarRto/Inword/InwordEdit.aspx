<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InwordEdit.aspx.cs" Inherits="oldCarRto.Inword.InwordEdit" %>
...
<div>
    ...
    <div style="width:100%; padding:1% 2% 0 2%; height:auto">
        <div class="dropDiv">
            Name :<asp:TextBox ID="txt_name" ReadOnly="true" runat="server" placeholder="Name..." 
                    Style="border-radius:5px;"
                    Width="148px"></asp:TextBox>
            </div>
        <div class="dropDiv">
        Mo. No. :<asp:TextBox ID="txt_contact"  ReadOnly="true" runat="server" placeholder="Mobile No..." 
                    Style="border-radius:5px;"
                    Width="148px"></asp:TextBox>
                    
        </div>
         <div class="dropDiv">
        Address :<asp:TextBox ID="txt_address" ReadOnly="true" TextMode="MultiLine" runat="server" placeholder="Address..." 
                    Style="border-radius:5px;"
                    Width="148px"></asp:TextBox>
        </div>
        <div class="dropDiv">
    ...
    <div style="width:100%; padding:1% 2% 1% 2%; text-align:center;">
     <div class="dropDiv">
        Vehicle No :<asp:TextBox ID="txt_vehicleNo" ReadOnly="true" runat="server" placeholder="Vehicle No..." 
                    Style="border-radius:5px;"
                    Width="148px"></asp:TextBox>
        </div>
    <div class="dropDiv">
        Chassis No :<asp:TextBox ID="txt_chassis" ReadOnly="true" runat="server" placeholder="Chassis No..." 
                    Style="border-radius:5px;"
                    Width="148px"></asp:TextBox>
        </div>
     <div class="dropDiv">
        Vehicle Type :<asp:TextBox ID="txt_vehicleType" ReadOnly="true" runat="server" placeholder="Vehicle Type..." 
                    Style="border-radius:5px;"
                    Width="148px"></asp:TextBox>
        </div>
    ...
    <div class="blockDiv">
     <div class="headDiv"><asp:Image ID="Image5" ImageUrl="~/images/3d.jpg" runat="server" CssClass="imageStyle" />
                          Other Details</div>
     <div style="width:100%; padding:1% 2% 1% 2%; text-align:center;">
        <div class="dropDiv">
        Note :<asp:TextBox ID="txt_Note" TextMode="MultiLine" runat="server" placeholder="Note ..." 
                    Style="border-radius:5px;"
                    Width="148px"></asp:TextBox>
        </div>
        <div class="dropDiv">
        Status :<asp:DropDownList ID="drp_Status" runat="server" class="chosen-select" Width="148px">
                <asp:ListItem>Pending</asp:ListItem>
                <asp:ListItem>Ok</asp:ListItem>
            </asp:DropDownList>
        </div>
        <div class="dropDiv">
        Closing Date :<asp:TextBox ID="txt_closingDate" runat="server" placeholder="DD/MM/YYYY" 
                    Style="border-radius:5px;"
                    Width="148px" AutoPostBack="True" 
                ontextchanged="txt_closingDate_TextChanged"></asp:TextBox>
        </div>
     </div>
    </div>
    <div class="blockDiv">
        <div class="headDiv"><asp:Image ID="Image4" ImageUrl="~/images/3d.jpg" runat="server" CssClass="imageStyle" /></div>
        <div class="dropDiv" style="float:left; padding:2px">
          <asp:Button ID="btn_delete" runat="server" Text="Delete" 
                CssClass="primary-button" onclick="btn_delete_Click" 
                 />
         </div>
