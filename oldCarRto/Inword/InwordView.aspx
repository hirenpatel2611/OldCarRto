<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InwordView.aspx.cs" Inherits="oldCarRto.Inword.InwordView" %>
     ...
     <div style="margin:10px; display:inline-block; width:100% ">
        <div class="headDiv">
            ...
            <asp:Button ID="btn_search" runat="server" Text="Search" 
                CssClass="primary-button" onclick="btn_search_Click" />
        </div>
        <div class="headDiv">
             <asp:Button ID="btn_addnew" runat="server" Text="ADD NEW" 
                 CssClass="primary-button" onclick="btn_addnew_Click" />
        </div>
        <div class="headDiv">
